...
echo
echo "== agent-host =="
(cd "$ROOT/modules/agent-host" && python3 -m py_compile bridge.py post_run_artifacts.py prepare_intent.py prepared_context.py tests/test_bridge.py tests/test_prepare_intent.py tests/test_prepared_context.py && python3 -m unittest discover -s tests)
