...
class BridgeTests(unittest.TestCase):
    ...
    def test_result_persists_execution_evaluation_for_prepared_task(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(followup["provenance"]["artifact_role"], "followup_task_draft")
            self.assertEqual(followup["provenance"]["generated_by"], "agent_host_post_run_artifacts")
            self.assertEqual(ledger_note["provenance"]["artifact_role"], "ledger_note_draft")
            self.assertEqual(review_proposal["provenance"]["artifact_role"], "review_proposal_draft")
            ...
            self.assertEqual(
                response["operator_summary"]["next_safe_action"]["target_path"],
